...
import rehanced.com.simpleetherwallet.fragments.FragmentPriceetho;
...
//            startActivityForResult(intro, rehanced.com.simpleetherwallet.activities.AppIntroActivity.REQUEST_CODE);
        ...
        fragments[0] = new FragmentPriceetho();
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (type == rehanced.com.simpleetherwallet.activities.QRScanActivity.SCAN_ONLY) {
                    if (data.getStringExtra("ADDRESS").length() != 42 || !data.getStringExtra("ADDRESS").startsWith("0x")) {
                        snackError("Invalid Ether-1 address!");
                        return;
                    }
                ...
                new Handler().postDelayed(
                        new Runnable() {
                            ...
                            public void run() {
                                if (fragments != null) {
                                    if (fragments[0] != null)
                                        ((FragmentPriceetho) fragments[0]).update(true);
                                    if (fragments[1] != null) {
        ...
        switch (position) {
            ...
            case 3: {
                new AlertDialog.Builder(this)
                        .setTitle("About Ether-1 Wallet")
                        .setMessage("Ether-1 Wallet is a fork of Lunary is published under GPL3\n" +
                                "Developed by Manuel S. C. for Rehanced, 2017\n"
                                + "www.rehanced.com\n" +
                                getString(R.string.translator_name) + "\n" +
                                "\nCredits:\n" +
                                "Credits by itsmylife44 europool.me\n" +
            ...
            case 4: {
                ...
                i.setData(Uri.parse("https://discord.gg/RA4AZx9"));
                startActivity(i);
                break;
            }
            case 5: {
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse("https://ether1.org/"));
                startActivity(i);
                break;
            }
            case 6: {
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse("http://twitter.com/Ether1Official"));
                startActivity(i);
                break;
            }
            case 7: {
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse("https://github.com/Ether1Project"));
                startActivity(i);
                break;
            }
            case 8: {
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse("https://www.reddit.com/r/ether1/"));
                startActivity(i);
                break;
            }
            case 9: {
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse("https://t.me/Ether_1"));
                startActivity(i);
                break;
            }
            case 10: {
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse("https://facebook.com/Ether1Official"));
                startActivity(i);
                break;
            }
            case 11: {
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse("https://bitcointalk.org/index.php?topic=3725742.0"));
                startActivity(i);
                break;
            }
            case 12: {
                if (WalletStorage.getInstance(this).getFullOnly().size() == 0) {
                    ...
                    donate.putExtra("TO_ADDRESS", "0xdfdbe46a630fbde2da1cea59cd18960843268fb7");
