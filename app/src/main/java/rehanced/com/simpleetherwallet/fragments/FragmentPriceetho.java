...
import rehanced.com.simpleetherwallet.views.ethoFormatter;
...
public class FragmentPriceetho extends android.support.v4.app.Fragment {
    ...
    private void setupChart(LineChart chart, LineData data, int color) {
        ...
        leftAxis.setValueFormatter(new ethoFormatter(displayInUsd));
